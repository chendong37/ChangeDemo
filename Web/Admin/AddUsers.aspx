<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMasterPag.Master"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="Change.Web.Admin.AddUsers" %>
     ...
     <div class="add_yfmb_style">
            <ul class="add_template_style">
                ...
                <li class="center">
                    ...
                    <a href="Users.aspx" class="quxiao_btn">取消新增</a>
                </li>
