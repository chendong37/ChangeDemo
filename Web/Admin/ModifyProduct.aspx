<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMasterPag.Master"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="ModifyProduct.aspx.cs" Inherits="Change.Web.Admin.ModifyProduct" %>
            ...
            <ul class="add_template_style">
                ...
                <li>
                    <label class="name">商品分类</label><div class="add_content">
                        <asp:DropDownList ID="CateIdDropDownList1" runat="server"></asp:DropDownList>
                    </div>
                </li>
                <li>
                    <label class="name">市场价格</label><div class="add_content">
                        <asp:TextBox ID="txtMarketPrice" CssClass="addtext_name" runat="server" Width="300px"></asp:TextBox>
                    </div>
                </li>
                <li>
                    <label class="name">本站价格</label><div class="add_content">
                        <asp:TextBox ID="txtPrice" CssClass="addtext_name" runat="server" Width="300px"></asp:TextBox>
                    </div>
                </li>
                <li>
                    <label class="name">商品库存</label><div class="add_content">
                        <asp:TextBox ID="txtStock" CssClass="addtext_name" runat="server" Width="300px"></asp:TextBox>
                    </div>
                </li>
                <li>
                ...
                <li class="center">
                    ...
                    <a href="Product.aspx" class="quxiao_btn">取消</a>
                </li>
