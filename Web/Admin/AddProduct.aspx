<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMasterPag.Master"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Change.Web.Admin.AddProduct" %>
     ...
     <div class="add_yfmb_style">
            <ul class="add_template_style">
                ...
                <li class="center">
                    ...
                    <a href="Product.aspx" class="quxiao_btn">取消新增</a>
                </li>
