<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMasterPag.Master" AutoEventWireup="true" CodeBehind="ModifyNews.aspx.cs" Inherits="Change.Web.Admin.ModifyNews"  ValidateRequest="false" %>
    ...
    <div class="add_yfmb_style">
            <ul class="add_template_style">
                ...
                <li class="center">
                    ...
                    <a href="News.aspx" class="quxiao_btn">
                        取消修改
                    </a>
                </li>
