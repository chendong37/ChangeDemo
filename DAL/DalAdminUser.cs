...
namespace Change.DAL
{
	...
	/// 数据访问类:AdminUser
	/// </summary>
	public partial class DalAdminUser
	{
		public DalAdminUser()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelAdminUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelAdminUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelAdminUser GetModel(int SuId)
		{
			...
			ModelAdminUser model=new ModelAdminUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelAdminUser DataRowToModel(DataRow row)
		{
			ModelAdminUser model=new ModelAdminUser();
			if (row != null)
			{
