...
namespace Change.DAL
{
	...
	/// 数据访问类:Favorite
	/// </summary>
	public partial class DalFavorite
	{
		public DalFavorite()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("FavoriteID", "tb_Favorite"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelFavorite model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelFavorite model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelFavorite GetModel(int FavoriteID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 FavoriteID,ProductId,UserId from tb_Favorite ");
			strSql.Append(" where FavoriteID=@FavoriteID");
			SqlParameter[] parameters = {
					new SqlParameter("@FavoriteID", SqlDbType.Int,4)
			};
			...
			ModelFavorite model=new ModelFavorite();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelFavorite DataRowToModel(DataRow row)
		{
			ModelFavorite model=new ModelFavorite();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select FavoriteID,ProductId,UserId ");
			strSql.Append(" FROM tb_Favorite ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" FavoriteID,ProductId,UserId ");
			strSql.Append(" FROM tb_Favorite ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_Favorite T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_Favorite";
