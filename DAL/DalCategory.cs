...
namespace Change.DAL
{
	...
	/// 数据访问类:Category
	/// </summary>
	public partial class DalCategory
	{
		public DalCategory()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelCategory model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelCategory model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelCategory GetModel(int CateId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelCategory DataRowToModel(DataRow row)
		{
			ModelCategory model=new ModelCategory();
			if (row != null)
			{
