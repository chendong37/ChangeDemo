...
namespace Change.DAL
{
	...
	/// 数据访问类:Orders
	/// </summary>
	public partial class DalOrders
	{
		public DalOrders()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelOrders model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelOrders model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelOrders GetModel(int OrdersID)
		{
			...
			ModelOrders model=new ModelOrders();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelOrders DataRowToModel(DataRow row)
		{
			ModelOrders model=new ModelOrders();
			if (row != null)
			{
