...
namespace Change.DAL
{
	...
	/// 数据访问类:Product
	/// </summary>
	public partial class DalProduct
	{
		public DalProduct()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelProduct model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelProduct model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelProduct GetModel(int ProductId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelProduct DataRowToModel(DataRow row)
		{
			ModelProduct model=new ModelProduct();
			if (row != null)
			{
