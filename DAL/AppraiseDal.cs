...
namespace Change.DAL
{
	...
	/// 数据访问类:Appraise
	/// </summary>
	public partial class AppraiseDal
	{
		public AppraiseDal()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(AppraiseModel model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(AppraiseModel model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public AppraiseModel GetModel(int AppraiseId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public AppraiseModel DataRowToModel(DataRow row)
		{
			AppraiseModel model=new AppraiseModel();
			if (row != null)
			{
