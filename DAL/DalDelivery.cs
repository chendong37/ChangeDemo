...
namespace Change.DAL
{
	...
	/// 数据访问类:Delivery
	/// </summary>
	public partial class DalDelivery
	{
		public DalDelivery()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelDelivery model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelDelivery model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelDelivery GetModel(int DeliveryID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelDelivery DataRowToModel(DataRow row)
		{
			ModelDelivery model=new ModelDelivery();
			if (row != null)
			{
