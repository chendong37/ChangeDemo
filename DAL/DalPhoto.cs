...
namespace Change.DAL
{
	...
	public partial class DalPhoto
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelPhoto model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelPhoto model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelPhoto GetModel(int PhotoId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelPhoto DataRowToModel(DataRow row)
		{
			ModelPhoto model=new ModelPhoto();
			if (row != null)
			{
