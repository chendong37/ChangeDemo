...
namespace Change.DAL
{
	...
	/// 数据访问类:OrdersDetail
	/// </summary>
	public partial class DalOrdersDetail
	{
		public DalOrdersDetail()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("DetailID", "tb_OrdersDetail"); 
		}
		...
		public bool Exists(int DetailID)
		{
			...
			strSql.Append("select count(1) from tb_OrdersDetail");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelOrdersDetail model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelOrdersDetail model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete(int DetailID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_OrdersDetail ");
			strSql.Append(" where DetailID=@DetailID");
			SqlParameter[] parameters = {
					new SqlParameter("@DetailID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelOrdersDetail GetModel(int DetailID)
		{
			...
			ModelOrdersDetail model=new ModelOrdersDetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelOrdersDetail DataRowToModel(DataRow row)
		{
			ModelOrdersDetail model=new ModelOrdersDetail();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select DetailID,OrdersID,ProductId,Quantity,States ");
			strSql.Append(" FROM tb_OrdersDetail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" DetailID,OrdersID,ProductId,Quantity,States ");
			strSql.Append(" FROM tb_OrdersDetail ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_OrdersDetail T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_OrdersDetail";
