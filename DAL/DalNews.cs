...
namespace Change.DAL
{
	...
	public partial class DalNews
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ModelNews model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ModelNews model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelNews GetModel(int NewsID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public ModelNews DataRowToModel(DataRow row)
		{
			ModelNews model=new ModelNews();
			if (row != null)
			{
